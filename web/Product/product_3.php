...
<body>
    <div class="container">
        <div class="card mb-5 shadow rounde">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <img src="<?=$prod_image[2]; ?>" class="img-thumbnail shadow p-1 mb-3 bg-white rounded">
                    </div>
                </div>
                <p align="center"><b><?=$prod_name[2]; ?></b></p>
                <hr>
                <article class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-8" align="left"><?=$prod_cate[2]; ?></div>
                </div>
                <div class="row">
                    <div class="col-4" align="right"><b>Stock : </b></div>
                    <div class="col-8" align="left"><?=$prod_stock[2] . " ชิ้น"; ?></div>
                </div>
                <div class="row">
                    <div class="col-4" align="right"><b>Price : </b></div>
                    <div class="col-8" align="left"><?=$prod_price[2] . " บาท"; ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="row">
            ...
            <input type="hidden" name="prodID" value="<?=$prod_id[2]?>">
