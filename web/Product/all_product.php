        ...
        <div class="row" align="center">
            <div class="col-6 p-1">
                <div class="card card-body p-0 m-0">
                    <img src="<?=$prod_image[0]?>" class="img-thumbnail p-0 m-0" style="width: 200px; height: 200px;"/>
                </div>
            </div>
            <div class="col-6 p-1">
                <div class="card card-body p-0 m-0">
                <img src="<?=$prod_image[1]?>" class="img-thumbnail p-0 m-0" style="width: 200px; height: 200px;"/>
                </div>
            </div>
        </div>
    </div>
